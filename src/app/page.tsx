    ...
    <div className="flex flex-col gap-32">
      ...
      <section id="hobbies" className="min-h-screen pt-24 pb-32">
        <div className="space-y-4 mb-12">
          ...
          <p className="text-accent font-light italic">Small moments of creativity and curiosity.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {hobbies.map((hobby) => (
            ...
            >
              ...
              {/* Content Overlay: Only visible/focused on hover */}
              <div className="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-white/80 via-transparent to-transparent 
